...
const M = {
  ...
  es: {
    ...
    weakestAfter: " —",
    practiceThis: "Practicar solo este tipo de spot",
    ...
    boardCount: (n: number) => `${n} jugadores hoy`,
    boardMyRank: (r: number) => `mi puesto #${r}`,
    boardLoginHint:
      "Inicia sesión para poner tu nombre en el ranking — verlo está abierto a todos.",
    ...
    gtoNoteAfter: ": ≤0.35% óptima · ≤1% aceptable · más que eso, repasa el spot.",
    spotLimits: (pot: string, best: string, good: string) =>
